...
const DropdownUser = () => {
    ...
    const handleSignout = async () =>  {
        ...
        if (userLoginData) localStorage.removeItem('userLoginData');
        userContext.setUserSession([]);
        navigate("/backend");
    }

    return (
        <div>
            <div className="relative inline-block text-sm px-2 py-1 leading-none border rounded text-white border-white hover:border-transparent hover:text-teal-500 hover:bg-white mt-4 lg:mt-0">
                <Link
                    ref={trigger}
